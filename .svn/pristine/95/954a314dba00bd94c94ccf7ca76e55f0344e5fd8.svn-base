...
Page({
  ...
  findSchool: function(event) {
    ...
    wx.request({
      url: app.data.HOST + 'v1/schoolType?school_type_id=3&school_name=' + that.data.schoolName + '&school_area=&school_address=&school_nature=&school_major=',
      method: 'GET',
  ...
  initAll: function() {
    let that = this;
    wx.request({
      url: app.data.HOST + "v1/schoolType?school_type_id=3&school_name=&school_area=&school_address=&school_nature=&school_major=",
      method: "get",
      success: res => {
        console.log(res.data);
        that.setData({
  ...
  searchSchool: function () {
    ...
    wx.request({
      url: app.data.HOST + 'v1/schoolType?school_type_id=3&school_name=&school_area=' + that.data.school_area + '&school_address=' + that.data.school_address + '&school_nature=&school_major=',
      method: 'get',
      success: function (res) {
